...
def generar_tablero(filas, columnas):
    ...
    # aseguramos que el numero de cartas no pida mas de las que hay
    if total_celdas > len(cartas):
        ...
        #barajamos las listas para asegurarnos de que el orden sea aleatorio
...
def loteria_filas_dinamicas(x):
        ...
        return render_template('tablero.html', filas=filas,
                                columnas=columnas, 
                                tablero=tablero)
# 3. Ruta para el nivel 3: tablero X y X
